...
type TraderSignalSubscriptionPlan struct {
	...
	AdminCommission float64   `gorm:"type:numeric(5,2);not null;default:0.0" json:"admin_commission_percentage"` // Stores the actual percentage at plan creation
	TraderShare     float64   `gorm:"type:numeric(18,4);not null;default:0.0" json:"trader_share"`               // Calculated share per plan
