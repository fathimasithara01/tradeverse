...
type TraderPerformance struct {
	...
	TotalROI        float64   `gorm:"type:numeric(10,4);default:0.00" json:"total_roi"` 
	...
	MaxDrawdown     float64   `gorm:"type:numeric(10,4);default:0.00" json:"max_drawdown"` 
	...
	ActiveCopiers   uint      `gorm:"default:0" json:"active_copiers"` 
	LastUpdated     time.Time `json:"last_updated"`
	TradingStyle    string    `gorm:"size:255" json:"trading_style,omitempty"` 
	Bio             string    `gorm:"type:text" json:"bio,omitempty"`          
	IsPublicProfile bool      `gorm:"default:true" json:"is_public_profile"`   
}
