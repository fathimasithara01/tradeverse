...
type customerSignalService struct {
	signalRepo    customerrepo.ICustomerSignalRepository     // Assuming a repository for customer-facing signals
	traderSubRepo customerrepo.ITraderSubscriptionRepository // To check subscriptions
}
...
func (s *customerSignalService) GetTraderSignalsForCustomer(ctx context.Context, customerID, traderID uint) ([]models.Signal, error) {
	...
	signals, err := s.signalRepo.GetSignalsByTraderID(ctx, traderID) // Assuming this method exists in your customer signal repo
	if err != nil {
...
func (s *customerSignalService) GetSignalCardForCustomer(ctx context.Context, customerID, traderID, signalID uint) (*models.Signal, error) {
	...
	signal, err := s.signalRepo.GetSignalByID(ctx, signalID) // Assuming this method exists
	if err != nil {
